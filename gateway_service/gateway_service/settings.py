...
SECRET_KEY = 'django-insecure-g7-*t_71s9*chg*#b-=!cm4odau_h-us3rbut*x3gzzh%iougf'
...
# All API calls go through Traefik
API_BASE_URL = 'http://localhost'   # Traefik entry point